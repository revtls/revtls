...
const (
	...
	extensionDDC                     uint16 = 10000
	//extensionDDCKeyLocation          uint16 = 10001
)
...
type Config struct {
	...
	// For compatibility with plain TLS protocol. This structure should not be
	// used in real world implementation. Instead of this structure, Other
	// deleation method, such as keyless ssl can be used.
	...
	DDC            *x509.DDC
	DDCProofRecord DDCProofRecord
	//DDCVersion     uint16
}

type DDCProofRecord struct {
	DDCProof_current  []byte
	DDCProof_previous []byte
	DDCVersion        uint16
}
...
func (c *Config) Clone() *Config {
	...
	return &Config{
		...
		DDCExtension:                c.DDCExtension,
		DDCKeyLocation:              c.DDCKeyLocation,
		DDCProofRecord:              c.DDCProofRecord,
	}
}
