...
SECStatus tls13_ClientSendDelegatedCredentialsXtn(const sslSocket *ss,
                                                  TLSExtensionData *xtnData,
                                                  sslBuffer *buf, PRBool *added);
SECStatus tls13_ClientSendDDCXtn(const sslSocket *ss,
                                TLSExtensionData *xtnData,
                                sslBuffer *buf, PRBool *added);
SECStatus tls13_ClientHandleDDCKeyLocationXtn(const sslSocket *ss, TLSExtensionData *xtnData,
                                              SECItem *data);
SECStatus tls13_ServerHandleDelegatedCredentialsXtn(const sslSocket *ss,
                                                    TLSExtensionData *xtnData,
                                                    SECItem *data);
SECStatus tls13_ClientHandleDDCBytes(const sslSocket *ss,
                                     TLSExtensionData *xtnData,
                                     SECItem *data);
#endif
