...
typedef enum {
    ...
    //DDC ERROR
    SSL_ERROR_DDC_CERT_VERIFY_ALG_MISMATCH = (SSL_ERROR_BASE + 192),
    SSL_ERROR_DDC_BAD_SIGNATURE = (SSL_ERROR_BASE + 193),
    SSL_ERROR_DDC_INVALID_KEY_USAGE = (SSL_ERROR_BASE + 194),
    SSL_ERROR_DDC_EXPIRED = (SSL_ERROR_BASE + 195),
    SSL_ERROR_DDC_INAPPROPRIATE_VALIDITY_PERIOD = (SSL_ERROR_BASE + 196),
